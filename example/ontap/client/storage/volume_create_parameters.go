...
// WithInfo adds the info to the volume create params
func (o *VolumeCreateParams) WithInfo(info *models.Volume) *VolumeCreateParams {
	o.SetInfo(info)
	return o
}

// SetInfo adds the info to the volume create params
func (o *VolumeCreateParams) SetInfo(info *models.Volume) {
	o.Info = info
}

// WithReturnRecords adds the returnRecords to the volume create params
func (o *VolumeCreateParams) WithReturnRecords(returnRecords *bool) *VolumeCreateParams {
	o.SetReturnRecords(returnRecords)
	return o
}

// SetReturnRecords adds the returnRecords to the volume create params
func (o *VolumeCreateParams) SetReturnRecords(returnRecords *bool) {
	o.ReturnRecords = returnRecords
}

// WithReturnTimeout adds the returnTimeout to the volume create params
func (o *VolumeCreateParams) WithReturnTimeout(returnTimeout *int64) *VolumeCreateParams {
	o.SetReturnTimeout(returnTimeout)
	return o
}

// SetReturnTimeout adds the returnTimeout to the volume create params
func (o *VolumeCreateParams) SetReturnTimeout(returnTimeout *int64) {
