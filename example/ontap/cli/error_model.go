...
func registerModelErrorFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	if err := registerErrorPropErrorInlineArguments(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerErrorPropErrorInlineArguments(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}

	// warning: error_inline_arguments []*ErrorArguments array type is not supported by go-swagger cli yet
...
func retrieveModelErrorFlags(depth int, m *models.Error, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	...
	err, ErrorInlineArgumentsAdded := retrieveErrorPropErrorInlineArgumentsFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || ErrorInlineArgumentsAdded
...
func retrieveErrorPropErrorInlineArgumentsFlags(depth int, m *models.Error, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false

	flagErrorInlineArgumentsName := fmt.Sprintf("%v.error_inline_arguments", cmdPrefix)
	if cmd.Flags().Changed(flagErrorInlineArgumentsName) {
		// warning: error_inline_arguments array type []*ErrorArguments is not supported by go-swagger cli yet
	}
